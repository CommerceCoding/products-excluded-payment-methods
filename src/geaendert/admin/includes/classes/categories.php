  ...
  */
  ...
  function insert_product($products_data, $dest_category_id, $action = 'insert') {
    ...
    $sql_data_array = array ('products_quantity' => xtc_db_prepare_input($products_data['products_quantity']),
                             ...
                             'products_excluded_payment_methods' => xtc_db_prepare_input(serialize($products_data['products_excluded_payment_methods'])) // Products Excluded Payment Methods - Commerce Coding
                             );
